...
if __name__ == '__main__':
    ...
    areas = {
        ...
        "武汉市":{"1":"武昌区", "2":"洪山区", "3":"江夏区", "4":"东西湖区", "5":"硚口区", "6":"汉阳区", "7":"汉口区", "8":"黄陂区", "9":"蔡甸区", "10":"新洲区"},
 ...
 '''
    ...
    # 也就是按照整数的顺序进行排序否则如果序号超过10，会出现1后面的是10而不是2，返回的是列表形式[( ,[]),(,[])]
    ...
    while province_flag:
        ...
        for province_item in province_list:
            print("\033[1;32;40m  %s: %s \033[1;m" ) % province_item #返回元组(,[]),(, [])...
        print("\033[1;32;40m+-----------------------------------+\033[1;m")
        # 获取用户输入的选项
        ...
        if province == 'q':
            ...
            province_flag = False
        elif province in provinces: #返回key的值
            # 如果输入的是菜单的序号执行
            # 获取省的名称
