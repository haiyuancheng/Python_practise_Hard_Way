...
Help:
'''
#{'zhangxiaoyu': ['123.com', 'unlock', '2'], 'lockuser': ['123456', 'unlock', '0'], '65brother': ['123456', 'unlock', '0']}
import os
# 定义用户信息写入函数，用于把用户信息写回文件
def write_to_account_file(accounts, account_file_path): #定义函数write_to_account_file
    account_file = open(account_file_path, 'w')  #以写的模式打开文件account_file_path
